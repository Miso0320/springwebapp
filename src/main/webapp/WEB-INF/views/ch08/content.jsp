...
<div class="card m-2">
	<div class="card-header">세션 이용 : 로그인</div>
	<div class="card-body">
		...
		<c:if test="${login != null}">
			...
			<a href="logout" class="btn btn-warning btn-sm mt-2">로그아웃</a>
		</c:if>
	</div>
</div>
	...
	<div class="card m-2">
		...
		<div class="card-body">
			<form method="post" action="addCart">
				...
				<button type="submit" class="btn btn-primary btn-sm">장바구니 넣기</button>
			</form>
			
			<a href="clearCart" class="btn btn-danger btn-sm mt-2">장바구니 비우기</a>
