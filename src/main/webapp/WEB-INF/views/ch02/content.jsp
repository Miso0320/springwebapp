	...
	<div class="card-body">
		<div class="card m-2">
			...
			<div class="card-body">
				<div class="m-2">
					<a
						href="method?bkind=free&bno=1"
						class="btn btn-info btn-sm">GET방식(&lt;a&gt;)</a>
				</div>
				<hr />
				<form class="m-2" method="get"
					...
					<div class="form-group">
						<label for="bno">bno</label> <input type="text"
							...
							id="bnoHelp" class="form-text text-muted">input board no</small>
					</div>
					<input type="submit" value="GET방식(&lt;form&gt;)"
						class="btn btn-info btn-sm" />
				</form>
				<hr />

				<div class="m-2">
					<button class="btn btn-info btn-sm" onclick="requestGet()">GET방식(Ajax)</button>
				</div>
			</div>
			<script>
            function requestGet() {
		...
		<div class="card m-2">
			<div class="card-header">PUT 방식 / DELETE 방식</div>
			<div class="card-body">
