      ...
      <div class="card m-2">
         ...
         <div class="card-body">
            ...
            <div class="mt-2">
               ...
               <button class="btn btn-info btn-sm" onclick="requestPost1()">POST 방식 요청1</button>
               <button class="btn btn-info btn-sm" onclick="requestPost2()">POST 방식 요청2</button>
            </div>
         </div>
         <script>
            function requestGet() {
            ...
            function requestPost2() {
                ...
                // {"param1":"문자열", "param"2:2, "param3":3.14, "param4":true, "param5":"2030-12-05"}
                $.ajax({
                   url:"method5",
                   method:"post",
                   contentType: "application/json; charset=UTF-8",
