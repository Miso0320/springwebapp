	...
	<div class="card-body">
		<div class="card">
	      ...
	      <div class="card">
	         ...
	         <div class="card-body">
	            <a id="link1" href="filedownload?saveFilename=${saveFilename}" class="btn btn-warning btn-sm" >파일 다운로드</a>
	            <a href="javascript:filedownload()" class="btn btn-warning btn-sm">파일 보기</a>
	            <hr/>
